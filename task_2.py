...
class Graph:
    ...
    def ucs(self, source_node, target_node, graph_dict, dist_dict, cost_dict, energy_constrain):
        ...
        while not priority_queue.empty():
            ...
            for neighbor in graph_dict.get(str(current_node)):
                ...
                if new_cost < energy_constrain and new_distance < old_distance:
...
def main():
    ...
    print("STP with  cost using UCS algo with python")

    # Create instance of graph
    graph = Graph(264436)

    # Activate algorithm
    graph.ucs(source_node, target_node, graph_dict, dist_dict, cost_dict, energy_constrain)
